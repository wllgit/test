...
class Column extends Model{
    ...
    //查询数据
    public function getColumns($where = '',$field= '*', $order = 'c.id desc', $offset = '', $limit = ''){
        return $this->alias('c')->join('scs_admin a','c.admin_id = a.id')->where($where)->field($field)->order($order)->paginate(10);
    }
